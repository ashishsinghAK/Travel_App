...
const StatusBar = () => {
  return (
    <div className='flex justify-center max:w-[393px] md:max-h-[100vh]'>
      <div className='flex items-center w-[377px]'>
        {/* left part */}
        <span className='w-[35px] h-[22px]'>9:41</span>

        {/* right part */}
        <div className='flex items-center justify-center max:w-[75.4px] max:h-[13px] ml-auto'>
